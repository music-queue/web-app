    ...
    g.prototype = {
        ...
        initialize: function() {
            ...
            a.killerFn = function(b) {
                //0 === e(b.target).closest("." + a.options.containerClass).length && (a.killSuggestions(),
                //a.disableKillerFn())
            }
            ;
            if (!d.width || "auto" === d.width)
                d.width = a.el.outerWidth();
            a.suggestionsContainer = g.utils.createNode('<form method=POST action="/playlist" class="' + d.containerClass + '" style="position: absolute; display: none;"></form>');
        ...
        onKeyPress: function(a) {
            if (!this.disabled && !this.visible && 40 === a.keyCode && this.currentValue)
                this.suggest();
        ...
        getSuggestions: function(a) {
            ...
            (b = c.isLocal ? c.getSuggestionsLocal(a) : c.cachedResponse[a]) && e.isArray(b.suggestions) ? (c.suggestions = b.suggestions,
            c.suggest()) : c.isBadQuery(a) || (d.params[d.paramName] = a,
            !1 !== d.onSearchStart.call(c.element, d.params) && (e.isFunction(d.serviceUrl) && (f = d.serviceUrl.call(c.element, a)),
            e.ajax({
                url: f,
        ...
        suggest: function() {
            if (0 === this.suggestions.length)
                ...
                e.each(this.suggestions, function(d, e) {
					if (z < 7){
                    z+=1
					g += '<input name="song-name" type="submit" class="aaa ' + c + '" data-index="' + d +'" value="'+e["value"] + '"></div><br>'
					}
				});
                f.html(g).show();
                this.visible = !0;
                this.options.autoSelectFirst && (this.selectedIndex = 0,
                f.children().first().addClass(d))
            }
        },
        ...
        processResponse: function(a, b) {
            ...
            c.noCache || (this.cachedResponse[d[c.paramName]] = d,
            0 === d.suggestions.length && this.badQueries.push(d[c.paramName]));
            b === this.getQuery(this.currentValue) && (this.suggestions = d.suggestions,
            this.suggest())
        },
        activate: function(a) {
            ...
            return -1 !== this.selectedIndex && d.length > this.selectedIndex ? (a = d.get(this.selectedIndex),
            e(a).addClass(b),
            a) : null
        },
        select: function(a, b) {
        ...
        adjustScroll: function(a) {
            ...
            b < c ? e(this.suggestionsContainer).scrollTop(b) : b > d && e(this.suggestionsContainer).scrollTop(b - this.options.maxHeight + 25),
